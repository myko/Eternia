...
namespace SkinnedModelPipeline
{
    ...
    public class SkinnedModelProcessor : ModelProcessor
    {
                                             ...
                                             ContentProcessorContext context)
        {
            ...
            foreach (BoneContent bone in bones.Take(MaxBones))
            {
            ...
            animationClips = ProcessAnimations(skeleton.Animations, bones.Take(MaxBones).ToList());
                                                        ...
                                                        ContentProcessorContext context)
        {
            ...
            effectPath = Path.GetFullPath(@"Shaders\SkinnedModelDualQuaternion.fx");
