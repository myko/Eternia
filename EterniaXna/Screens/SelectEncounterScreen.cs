...
namespace EterniaXna.Screens
{
    public class SelectEncounterScreen: MenuScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            encounters.Add(ContentManager.Load<EncounterDefinition>(@"Encounters\PointDread"));
            encounters.Add(ContentManager.Load<EncounterDefinition>(@"Encounters\SeaOfRakash"));
            encounters.Add(ContentManager.Load<EncounterDefinition>(@"Encounters\VineJungle"));
            encounters.Add(ContentManager.Load<EncounterDefinition>(@"Encounters\SnakeMountain"));
