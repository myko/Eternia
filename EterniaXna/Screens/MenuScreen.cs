...
namespace EterniaXna.Screens
{
    public class MenuScreen: GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            buttonTexture = ContentManager.Load<Texture2D>(@"Interface\button");
            buttonMouseOverTexture = ContentManager.Load<Texture2D>(@"Interface\button-mouseover");
            borderTexture = ContentManager.Load<Texture2D>(@"Interface\border-bones");
        }
